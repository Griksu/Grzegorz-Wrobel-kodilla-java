...
public class WeatherForecastTestingSuite {
    ...
    @DisplayName("Test for: Calculation forecast")
    @Test
    void testCalculationForecastWIthMock() {
        //Given
        //When
    ...
    @DisplayName("Test for: Calculation of average temperature")
    @Test
    ...
    @DisplayName("Test for: Getting the median temperature")
    @Test
    void testGetMedianTemperature() {
        //Given
        //When
        double medianTemp = weatherForecast.getMedianTemperature();
        //Then
